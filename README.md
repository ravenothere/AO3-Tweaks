...
<img src="https://raw.githubusercontent.com/ravenothere/Zen-Site-Appearance-Toggle/main/images/zen-site-appearance-toggle-preview.png" width="75%" />
...
- [AO3: Comment Formatting and Preview](https://greasyfork.org/en/scripts/484002-ao3-comment-formatting-and-preview) — *Adds buttons to insert text formatting to your comment, and shows a live preview box of what the comment will look like, very helpful especially for those who aren't familiar with HTML.*
...
- [AO3: No Re-Kudos](https://greasyfork.org/en/scripts/551623-ao3-no-re-kudos) — *automatically hides the kudos button on works where you've already left kudos.*
- [AO3: Auto Pseud](https://greasyfork.org/en/scripts/556232-ao3-auto-pseud) — *auto-selects your pseud for comments and bookmarks on AO3, based on fandom, all you need is to assign each pseud to your desired fandom.*
- [AO3 Tag Reorder](https://greasyfork.org/en/scripts/524994-ao3-tag-reorder) — *lets you rearrange tag order when editing a work, bookmark or collection very convenient and easy to use especially for authors and bookmarkers.*
